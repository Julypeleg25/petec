...
import { CaseSuggestionReferenceSchema } from "../caseSuggestion.dto.js";
...
const caseDetailsMedicineBaseSchema = baseMedicineSchema
  .omit({
    notes: true,
  })
  .extend({
...
export const caseDetailsMedicineObjSchema =
  caseDetailsMedicineBaseSchema.extend({
    isGiven: z.boolean().optional(),
    isRequired: z.boolean(),
    isEditable: z.boolean(),
    suggestionReference: CaseSuggestionReferenceSchema.optional(),
  });
...
export const UpdateDailyPlanRequestDTOSchema = z.record(
  z.string(),
...
export const caseDetailsHeaderSchema = z
  .object({
...
export const populatedMedicineRefSchema = z
  .object({
    id: z.string(),
    name: z.string(),
  })
...
export const responseMedicineItemSchema = z
  .object({
    medicineId: objectIdSchema,
    value: z.string(),
    text: z.string(),
...
export const responseOptionItemSchema = z
  .object({
    value: z.string(),
    text: z.string(),
    isGiven: z.boolean(),
...
export const responseExaminationItemSchema = z
  .object({
    value: z.string(),
    text: z.string(),
...
const masterCaseDetailSchema = z
  .object({
    caseId: z.string(),
...
export const CaseDetailsResponseDTOSchema = z
  .object({
...
export const DailyPlanDetailDTOSchema = z.object({
  ...
  caseExaminations: z.array(
    z.object({ name: z.string(), value: z.string(), date: z.string() }),
  ),
  caseProcedures: z.array(
    z.object({ name: z.string(), value: z.boolean(), date: z.string() }),
  ),
  ownerUpdate: z.array(z.object({ value: z.string(), date: z.string() })),
  releaseMedicines: z.array(z.object({ value: z.boolean(), date: z.string() })),
});

export const DailyPlanDetailListResponseDTOSchema = z.array(
...
export const CalendarPatientFlagsDTOSchema = z
  .object({
...
export const CalendarPatientItemDTOSchema = z
  .object({
    caseId: objectIdSchema,
...
export const CalendarDayDTOSchema = z
  .object({
...
export const CalendarMonthResponseDTOSchema = z
  .object({
