...
export const caseDetailsMedicineObjSchema = baseMedicineSchema.extend({
    name: z.string().optional(),
    isGiven: z.boolean().optional(),
    isRequired: z.boolean(),
    isEditable: z.boolean(),
    comment: z.string().optional(), // Preserved for backwards compatibility, can map to notes
});
...
export const ReleasePatientFormDTOSchema = ReleasePatientDTOSchema.pick({
    ...
    stitchesRemovalDate: z.string().nullable().optional(),
...
const caseDetailsHeaderSchema = z.object({
...
const responseMedicineItemSchema = z.object({
    medicineId: objectIdSchema,
    value: z.string(),
    text: z.string(),
    isGiven: z.boolean(),
    ...
    measureUnitTypeId: z.string().nullable().optional(),
    dosageFrequencyId: z.string().nullable().optional(),
    routeOfAdministrationId: z.string().nullable().optional(),
    notes: z.string().optional(),
}).strict();

const responseOptionItemSchema = z.object({
    value: z.string(),
    text: z.string(),
    isGiven: z.boolean(),
    isRequired: z.boolean(),
...
const responseExaminationItemSchema = z.object({
    value: z.string(),
    text: z.string(),
...
const caseDailyDetailsRowSchema = z.object({
    id: z.string(),
    index: z.number(),
    time: z.string(),
    date: z.string(),
    ...
    T: z.string().nullable(),
    T_is_required: z.boolean(),
    T_is_editable: z.boolean(),

    P: z.string().nullable(),
    P_is_required: z.boolean(),
    P_is_editable: z.boolean(),

    R: z.string().nullable(),
    R_is_required: z.boolean(),
    R_is_editable: z.boolean(),
    ...
    food_and_water: z.string().nullable(),
    food_and_water_is_required: z.boolean(),
    food_and_water_is_editable: z.boolean(),

    urine_type_id: z.string().nullable(),
    urine_comments: z.string().nullable(),
    urine_is_required: z.boolean(),
    urine_is_editable: z.boolean(),

    feces_type_id: z.string().nullable(),
    feces_comments: z.string().nullable(),
    feces_is_required: z.boolean(),
    feces_is_editable: z.boolean(),

    is_box_clean: z.boolean().nullable(),
    is_box_clean_is_required: z.boolean(),
    is_box_clean_is_editable: z.boolean(),

    is_release: z.boolean().nullable(),
    is_release_is_required: z.boolean(),
    is_release_is_editable: z.boolean(),

    is_walk_trip: z.boolean().nullable(),
    is_walk_trip_is_required: z.boolean(),
    is_walk_trip_is_editable: z.boolean(),

    is_puke: z.boolean().nullable(),
    puke_comments: z.string().nullable(),
    puke_is_required: z.boolean(),
    puke_is_editable: z.boolean(),

    weigh: z.string().nullable(),
    weigh_is_required: z.boolean(),
    weigh_is_editable: z.boolean(),

    comments: z.string().nullable(),
    comments_is_required: z.boolean(),
    comments_is_editable: z.boolean(),

    owner_update: z.string().nullable(),
    owner_update_is_required: z.boolean(),
    owner_update_is_editable: z.boolean(),
});
