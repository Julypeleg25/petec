...
export const medicineApi = {
    ...
    getAllByCategoryType: (categoryType: MedicineCategoryType): Promise<MedicineDTO[]> =>
        requestWithSchema(
            {
                method: HTTP_METHODS.GET,
                url: API_ROUTES.medicine.getAllByCategoryType(
                    CategoryTypeParamsDTOSchema.parse({ categoryType }).categoryType,
                ),
            },
            MedicineListResponseDTOSchema,
        ),
