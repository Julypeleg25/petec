...
export const API_ROUTES = {
  ...
  admin: {
    ...
    types: {
      ...
      edit: (typeName: SystemTypeName, id: string) =>
        typeRoute(typeName) + "/" + id,
      delete: (typeName: SystemTypeName, id: string) =>
        typeRoute(typeName) + "/" + id,
    ...
    animalVitals: {
      ...
      allByAnimalId:
        ADMIN + "types/" + SYSTEM_TYPE_NAMES.ANIMAL_VITALS + "/animal",
    },
    ...
    raceType: {
      ...
      allByAnimalId:
        ADMIN + "types/" + SYSTEM_TYPE_NAMES.RACE_TYPES + "/animal",
    },
    ...
    routeOfAdministration: makeTypeAliases(
      SYSTEM_TYPE_NAMES.ROUTES_OF_ADMINISTRATION,
    ),
    anesthesiaFormTexts: makeTypeAliases(
  ...
  patient: {
    ...
    caseSuggestions: (patientId: string, category: string) =>
      PATIENT + patientId + "/case-suggestions/" + category,
  },
  medicine: {
    getAll: MEDICINE + "all",
