...
export const toCaseDetailsMedicineCell = (
    ...
    return {
        ...
        ...(medicine.totalDose !== undefined ? { totalDose: medicine.totalDose } : {}),
...
export const hydrateCaseDetailsMedicineCell = (
    ...
    return {
        ...
        medicineComments:
            medicine.medicineComments ??
            catalogMedicine.comments ??
            "",
    };
};
...
export const toMedicineSelectOption = (
    ...
    frequencyText: medicine.frequencyText ?? "",
    doseAmount:
        medicine.doseAmount === null || medicine.doseAmount === undefined || medicine.doseAmount === ""
            ? undefined
