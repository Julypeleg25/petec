      ...
      <div className="save-entity-form-container save-user-form-container">
        <div className="save-user-dialog__header">
          ...
          <div className="save-user-dialog__title-wrap">
            <p className="save-user-dialog__subtitle">עריכה</p>
            <h2 className="save-entity-form-title">עריכת משתמש</h2>
            <p className="save-user-dialog__current-name">
              משתמש נוכחי: <span>{user.username}</span>
            </p>
          </div>
        </div>
        <form
