...
export const mapGridDtoToRows = (
  ...
  grid.flat().map((row) => ({
    ...
    fluids: row.fluids.map((fluid) => ({
      ...
      suggestionReference: fluid.suggestionReference,
    })),
    ...
    procedures: row.procedures.map((procedure) => ({
      ...
      suggestionReference: procedure.suggestionReference,
    })),
    examinations: row.examinations.map((examination) => ({
      ...
      suggestionReference: examination.suggestionReference,
    })),
    foodExtras: row.foodExtras.map((foodExtra) => ({
      ...
      suggestionReference: foodExtra.suggestionReference,
    })),
  }));
