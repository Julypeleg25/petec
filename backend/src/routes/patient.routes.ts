...
const PATIENT_ROUTE_PATHS = {
    ...
    CASE_DAILY_DETAILS_LEGACY: "/case/caseDailyDetails/:caseId",
    CASE_DETAILS_WITH_MASTER: "/case/details/:masterCaseId/:caseId",
    CASE_DETAILS_LEGACY: "/case/details/:caseId",
...
router.get(
    PATIENT_ROUTE_PATHS.CASE_DAILY_DETAILS_LEGACY,
    requirePermission(Permission.READ_CASE),
    validateParams(CaseIdParamsDTOSchema),
    patientController.getCaseDetails,
);
...
router.get(
    PATIENT_ROUTE_PATHS.CASE_DETAILS_LEGACY,
    requirePermission(Permission.READ_CASE),
    validateParams(CaseIdParamsDTOSchema),
    patientController.getCaseDetails,
);
