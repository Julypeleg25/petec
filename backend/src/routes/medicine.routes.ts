...
const MEDICINE_ROUTE_PATHS = {
    ALL: "/all",
    BY_CATEGORY: "/getAllByCategoryType/:categoryType",
...
router.get(MEDICINE_ROUTE_PATHS.BY_CATEGORY, validateParams(CategoryTypeParamsDTOSchema), medicineController.getAllByCategoryType);
